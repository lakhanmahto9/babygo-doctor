  ...
  return (
    ...
    >
      ...
      <div className="h-[15%] p-2">
        <div
          className={`w-full h-full rounded-lg flex gap-8 justify-center items-center ${isDarkEnabled ? "bg-[#101c44]" : "bg-[#fbf5ff]"}`}
        >
          <div>
          ...
          <div
            onClick={logoutfunc}
            className="w-10 h-10 bg-[#9e78ce] rounded-full flex justify-center items-center cursor-pointer"
          >
